...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2023 at 11:15 AM
...
(114, 95217, 'modi', 'unde', 'sed', '', 12812472, 'aut', 'aperiam', 'recusandae', '', 0, '', 'Meeting', '2023-02-22', '2023-02-22', '17:46:00');
...
INSERT INTO `podms_profiling` (`id`, `id_number`, `first_name`, `middle_name`, `last_name`, `section`, `course`, `inci_desc`, `inci_date`, `inci_time`, `violation_level`, `violation`, `duties`, `duty_start`, `duty_end`, `duty_location`, `status`, `image_name`, `date`) VALUES
...
(118, 17003, 'Angelo', 'Hartnett', 'Fortney', '', 'Harvey Inc', '', '', '', 'grave', 'DOLOREM ID CORRUPTI OMNIS VITAE EST UT TEMPORIBUS.', 'community service, duty', '04:17:00', '04:17:00', 'Canteen', 2, 'IMG-63f7c9db1e3f38.26933207.png', '2023-02-10'),
