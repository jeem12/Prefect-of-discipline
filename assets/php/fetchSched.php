...
if(isset($_POST['view'])){
    ...
    if(mysqli_num_rows($result) > 0)
    {
        ...
        if($query_update){
            $query_insert = "INSERT INTO `podms_notif` (`name`, `message`, `notif_status`,`link`) VALUES ('You have a pending schedule today!', 'Please check your schedule', 1,'../../../subsystem_folder/schedule.php')";
