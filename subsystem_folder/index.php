    ...
    <!-- Left side columns -->
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              <h5 class="card-title">Total Claimed Items <span>/Bar Chart</span></h5>
              ...
              $query = "
              SELECT date as date, COUNT(id) as total FROM podms_claimed_items GROUP BY date";
              $query_run = mysqli_query($conn, $query);
              ...
              <div class="chartBox">
                ...
                <input id="month" type="month" onchange="filterChart1(this)">
                <button onclick="downloadPDF()" id="pdf">Extract Report</button>
              </div>
              ...
              function filterChart1(date) {
                ...
                myChart1.config.options.scales.x.min = startDate;
                myChart1.config.options.scales.x.max = endDate;
                myChart1.update();
        ...
        </div><!-- End Reports for claimed items -->
