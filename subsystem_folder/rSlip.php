...
<?PHP 
    ...
    $age = $_POST['f3-age'];
    $sex = $_POST['f3-sex'];
    $reason = $_POST['f3-reason'];
    $reffto = $_POST['f3-reffto'];
            ...
            <div class="header">
                ...
                <div class="bill_total_wrap">
                    <div class="bill_sec">
                        ...
                        <p class="bold name">REFERRAL SLIP</p>
                    </div>
                </div>
            </div>
            <div class="body">
                <div class="main_table">
                    <div class="date">
                        <p>Date: &nbsp;<u> <strong><?= date("m-d-Y");?></strong></u> </p>
                    </div>
...
while($row = mysqli_fetch_array($query_run))
    {
     ?>
                    ...
                    <div class="content">
                        <p>Student's name: &nbsp; <strong><u><span style="text-transform:uppercase;"><?= $row['lastname'] .', ' . $row['firstname']?></span></u></strong></p>
                        <br>
<div class="container">
                   ...
                   <div class="row">
                            ...
                            <div class="col">
                                <p>Course <span style="text-transform: uppercase;" ><u><strong><?= $row['course']?></strong></u></span></p>
                            </div>
                            <div class="col">
                                <p>Year <span style="text-transform: uppercase;" ><u><strong><?= $row['year']?></strong></u></span></p>
                            </div>
                            <div class="col">
                                <p>Age:&nbsp;<u><strong><?= $age?></strong></u></p>
                            </div>
                            <div class="col">
                                <p>Sex: &nbsp;<u><strong><?= $sex?></strong></u></p>
                            </div>

                        </div>
                        </div>
                        <br>
                        <p>Reason for Referral:&nbsp;<u><strong> <span style="text-transform: uppercase;"><?= $reason ?></span></span> </strong></u></p>
                        <br><br>
                        <p>Referred to:&nbsp;<u><strong> <span style="text-transform: uppercase;"><?= $reffto ?></span></span> </strong></u></p>
