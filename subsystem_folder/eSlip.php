            ...
            <div class="header">
                ...
                <div class="bill_total_wrap">
                    <div class="bill_sec">
                        ...
                        <p class="bold name">ENTRY PASS</p>
                    </div>
                </div>
            </div>
            <div class="body">
...
while($row = mysqli_fetch_array($query_run))
    {
     ?>
                    ...
                    <div class="content">
                        <p>Please allow <strong><u><span
                                    style="text-transform:uppercase;"><?= $row['firstname'] .' ' . $row['lastname']?></span></u></strong>
                            from <strong><u><span
                                    style="text-transform:uppercase;"><?= $row['course']?></span></u></strong> of <strong><u><?= $row['section']?></u></strong>, to enter the school premises.
                        </p>
                        <br>
                        <p class="footerG"><strong>Reason:&nbsp;<u><span style="text-transform: uppercase;"><?= $reason?></span></span></u></strong></p><br><br>
                        <p style="display: flex;
        justify-content: center; color: red;"><small>*This Entry Pass is valid only on the date specified.</small></p>
                    </div>
