                    ...
                    <table id="myTable1" class="table table-striped nowrap" style="width:100%">
                        <div class="col-lg-auto">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="month" class="form-control" name="fromDate" id="fromDate">
                                <span class="input-group-text">to</span>
                                <input type="month" class="form-control" name="toDate" id="toDate">
                            </div>
            ...
            responsive: {
                details: {
                    display: $.fn.dataTable.Responsive.display.modal({
                        header: function(row) {
                            var data = row.data();
                            return 'Details for ' + data.complained_last_name + ', ' + data
